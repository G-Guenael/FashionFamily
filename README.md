...
- `.htaccess` bloque l'accès direct aux fichiers sensibles (`.sql`, `.log`, `.env`)
...
Projet réalisé dans le cadre d'un projet scolaire / personnel.

| Contributeur | Rôle |
|---|---|
| Kevin | Backend, architecture MVC, base de données |
| Guenael | *(voir historique git)* |
