        ...
        <div class="container_bottom_right card">
            <div class="card_header">
                <div class="txt">
                    ...
                    <a href="<?= BASE_URL ?>/admin/products" style="position:absolute;top:20px;left:170px;font-size:12px;color:#5c5f6a;line-height:1.75;letter-spacing:5%;border:1px solid #5c5f6a23;border-radius:8px;padding:2px 16px;background:#f6f6f6;text-decoration:none;">Voir tout</a>
                </div>
                <div class="table">
                    <table>
                        <thead>
                            ...
                            <?php if (!empty($recentArticles)): ?>
                                <?php foreach ($recentArticles as $article): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars(ucfirst($article['status'] ?? '-'), ENT_QUOTES, 'UTF-8') ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="4" style="text-align:center;color:#5c5f6a;">Aucun article pour le moment</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
